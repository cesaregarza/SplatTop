...
class Player(Base):
    ...
    __table_args__ = (
        ...
        Index(
            "idx_players_updated_season_player_mode_region_xpower",
            "season_number",
            "player_id",
            "mode",
            "region",
            text("x_power DESC"),
            postgresql_where=text("updated IS TRUE"),
        ),
        Index(
            "idx_players_updated_season_player_mode_region_ts",
            "season_number",
            "player_id",
            "mode",
            "region",
        ...
        Index(
            "idx_players_player_timestamp_covering",
            "player_id",
            "timestamp",
            postgresql_include=[
                "mode",
