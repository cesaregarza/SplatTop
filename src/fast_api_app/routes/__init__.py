from fast_api_app.routes.analytics import router as analytics_router
from fast_api_app.routes.admin_tokens import router as admin_tokens_router
from fast_api_app.routes.comp_auth import router as comp_auth_router
...
from fast_api_app.routes.ripple_public import (
    admin_router as ripple_admin_router,
)
from fast_api_app.routes.ripple_public import router as ripple_public_router
from fast_api_app.routes.ripple_public import (
    share_router as ripple_share_router,
)
from fast_api_app.routes.search import router as search_router
from fast_api_app.routes.sendou_proxy import router as sendou_proxy_router
...
from fast_api_app.routes.weapon_leaderboard import (
    router as weapon_leaderboard_router,
)
